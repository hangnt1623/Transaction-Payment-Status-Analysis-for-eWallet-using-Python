...
"""####Data types
- Đổi dtype của report_month sang datetime
- Đổi dtype của payment_group, category, team_own sang category -> phân loại dc
"""
...
"""####Missing Value
- category thiếu dữ liệu -> thêm "Unknown"
- team_own thiếu dữ liệu -> thêm "Uncategorized"
"""
...
"""####Data types
- Đổi dtype của transType & transStatus -> category -> phân loại
- Đổi dtype của sender_id & receiver_id -> int64 -> id ở dạng số nguyên
- Đổi dtype của extra_info -> string -> diễn giải thông tin cần điền thêm
- Đổi dtype của timeStamp -> datetime vì timeStamp là thời gian
"""
...
"""####Missing Value
sender_id, receiver_id bị thiếu dữ liệu -> điền -1 để chú ý
extra_info ko có dữ liệu -> có thể là không có thông tin gì thêm -> fill "No"
"""
...
"""####Duplicate Value
Có 28 dòng bị duplicates -> Next action: xóa 28 dòng này
"""
